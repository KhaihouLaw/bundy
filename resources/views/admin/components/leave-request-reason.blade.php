@php
    ...
    $status = $leave_request_model->getStatusBadge(2, '15px');
...
<div class="w-full">
    ...
    <div class="bg-light text-dark py-10 px-4 rounded-lg text-justify mb-3" style="text-indent: 50px; min-height: 300px;">
        {{ $reason }}
    </div>
